      ...
      <div className="container">
        ...
        <main className="content-area">
          ...
          <p className="payattention">
            This list contains only links to existing public web sites. I worked
            on multiple commercial web applications as well, however, they are
            not public (please see my resume for details).
          </p>
          <ul className="portfolio" data-behavior="colorLinks">
            <li>
              ...
              <span>
                (developed image rotator with video player for landing page; the
                player is implemented with <em>video</em> tag and fall back to
                Flash player if <em>video</em> tag is not supported, 2012)
              </span>
            </li>
            <li>
              <a
            ...
            <li>
              ...
              <span>
                (applied Yahoo! template/grid architecture and re-wrote CSS for
                the web site, 2009)
              </span>
            </li>
            <li>
              ...
              <span>
                (participated in re-designing Cox Communications, Inc. web site,
            ...
            <li>
              ...
              <span>
                (Full re-design of the website; XHTML, CSS, JavaScript, jQuery,
                PHP5, MySQL5, I18N, 2008 - 2009)
              </span>
            </li>
            <li>
              <a
              ...
              <span>
                (developed semantic HTML templates for ThankYou Rewards Network
                on-line shopping loyalty program for Citibank, 2008)
              </span>
            </li>
            <li>
              <a
            ...
            <li>
              ...
              <span>
                (designed and developed XHTML/CSS/SSI template architecture for
                the whole website; developed clear, cross-browser compatible,
                valid, CSS-based code according to W3C standards for layouts,
                templates, web pages), 2005&nbsp;-&nbsp;2007
              </span>
            </li>
            <li>
              <a
              ...
              <span>
                (developed cross-browser compatible, valid, W3C compliant XHTML
                code for layouts, templates, web pages for sections
            ...
            <li>
              ...
              <span>
                (PHP-MySQL, back end, admin site, connected back end with front
                end), 2003
              </span>
            </li>
            <li>
